...
## Corpus Check
- 47 files · ~54,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 538 nodes · 1070 edges · 20 communities (14 shown, 6 thin omitted)
...
1. `Room` - 83 edges
2. `RoomManager` - 45 edges
3. `RedisBroker` - 39 edges
4. `Client` - 36 edges
...
### Community 0 - "Room"
Cohesion: 0.09
Nodes (7): time.Duration, time.Timer, Room, webrtc.PeerConnection, webrtc.TrackLocalStaticRTP, NewRoomWithName(), CoHostMedia

### Community 1 - "Client"
Cohesion: 0.09
Nodes (20): encoding/json.RawMessage, github.com/gofiber/contrib/websocket.Conn, GetAppConfig(), SignalingMessage, ParseSignalingMessage(), TestParseSignalingMessage(), TestSignalingMessageEncode(), RoomManager (+12 more)

### Community 2 - "testing.T"
Cohesion: 0.08
Nodes (31): testing.T, TestNewRedisBroker_EmptyAddr(), TestRedisBroker_NilOperations(), NewRoom(), TestRoomCoHostTracks(), TestRoomSimulcastTracks(), TestRoomState(), TestRoomManager_ForceEndRoomKillSwitch() (+23 more)
