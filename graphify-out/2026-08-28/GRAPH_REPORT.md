...
## Corpus Check
- 50 files · ~61,124 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 610 nodes · 1248 edges · 18 communities (14 shown, 4 thin omitted)
...
### Community 1 - "Client"
Cohesion: 0.06
Nodes (26): encoding/json.RawMessage, github.com/gofiber/contrib/websocket.Conn, GetAppConfig(), SignalingMessage, RoomManager, webrtc.API, webrtc.PeerConnection, NewClient() (+18 more)

### Community 2 - "testing.T"
Cohesion: 0.09
Nodes (31): testing.T, TestNewRedisBroker_EmptyAddr(), TestRedisBroker_NilOperations(), ParseSignalingMessage(), TestParseSignalingMessage(), TestSignalingMessageEncode(), NewRoom(), NewRoomWithName() (+23 more)
...
Cohesion: 0.05
Nodes (27): github.com/pion/rtcp.NackPair, github.com/pion/rtp.Packet, sync.RWMutex, NewABRController(), NewDynacastEngine(), TestABRController_Evaluation(), TestDynacastEngine_SubscriberTracking(), NewPacketBuffer() (+19 more)
...
Cohesion: 0.06
Nodes (10): github.com/pion/webrtc/v3.TrackLocalStaticRTP, PKSession, RoomManager, NewPKManager(), broadcastRawToRoomInternal(), syncRoomStateInternal(), PKManager, RoomInfo (+2 more)
